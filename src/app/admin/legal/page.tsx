...
export default function AdminLegalPage() {
  ...
  return (
    <div className="p-6 max-w-3xl">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-black text-white">⚖️ Pages légales</h1>
        <p className="text-gray-500 text-sm mt-0.5">Mentions légales, confidentialité, cookies, allergènes</p>
      </div>
