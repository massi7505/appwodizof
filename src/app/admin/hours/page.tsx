  ...
  return (
    <div className="p-6 max-w-3xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-black text-white">🕐 Horaires d'ouverture</h1>
          <p className="text-gray-500 text-sm mt-0.5">Configurez les créneaux horaires de chaque jour</p>
        </div>
