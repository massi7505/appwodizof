  ...
  return (
    <div className="p-6 max-w-3xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-black text-white">🦸 Hero Section</h1>
          <p className="text-gray-500 text-sm mt-0.5">Gérer le slider hero et les cartes fonctionnalités</p>
        </div>
            ...
            {slides.map((slide, i) => (
              <div key={slide.id} className={`flex items-center gap-3 p-4 rounded-xl border transition-all ${slide.isVisible ? 'border-gray-700 bg-gray-800' : 'border-gray-800 bg-gray-900 opacity-60'}`}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500">{slide.buttons?.length || 0} bouton(s)</p>
                </div>
