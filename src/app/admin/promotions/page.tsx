...
const DEFAULT_PROMO = {
  ...
  badgeColor: '#EF4444', promoPrice: '', originalPrice: '', isVisible: true,
  showOnLinktree: true, showOnMenu: true,
        ...
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-start justify-center p-4 overflow-y-auto">
          <div className="bg-gray-900 rounded-2xl border border-gray-700 w-full max-w-2xl my-4">
            ...
            <div className="px-5 pt-5">
              ...
              <div
                className="relative rounded-2xl p-5 overflow-hidden min-h-[100px]"
                style={{
            ...
            <div className="flex gap-2 p-5 pt-0">
              ...
              <button onClick={save} disabled={saving || !editing.promoPrice} className="flex-1 admin-btn-primary disabled:opacity-50">{saving ? 'Sauvegarde...' : isNew ? 'Créer' : 'Sauvegarder'}</button>
            </div>
          </div>
        </div>
      )}
