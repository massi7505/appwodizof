  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-4 mb-8">
        {stats.map((stat, i) => (
          <Link
            key={stat.label}
            href={stat.href}
            className={`admin-fade-in-${i + 1} admin-kpi-card group ${stat.cls}`}
          >
      ...
      <div className="mb-8 admin-fade-in-4">
        <h2 className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: 'var(--admin-text-muted)' }}>
          Accès rapide
        </h2>
