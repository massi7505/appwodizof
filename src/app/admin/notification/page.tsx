...
export default function AdminNotificationPage() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      {toast && (
        <div className="fixed top-4 right-4 z-50 bg-gray-800 text-white px-4 py-3 rounded-xl shadow-lg text-sm animate-slide-in border border-gray-700">
          {toast}
        </div>
      )}
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-black text-white flex items-center gap-2">
            <Bell className="w-6 h-6 text-amber-400" /> Notifications intelligentes
          </h1>
